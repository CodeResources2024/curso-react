...
export const HeroPage = () => {
    ...
    const { data, isError } = useHeroData(idSlug);
                    ...
                    <div className="max-w-7xl mx-auto px-6 py-12">
                        <div className="flex flex-col md:flex-row items-center gap-8">
                            ...
                            <div className="flex-1 text-center md:text-left">
                                ...
                                <h1 className="text-4xl md:text-6xl font-bold mb-2">{data?.alias}</h1>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                ...
                                <Card className="text-center">
                                    <CardContent className="pt-6">
                                        ...
                                        <div className="text-3xl font-bold text-red-600 mb-2">{data?.strength}</div>
                                ...
                                <Card className="text-center">
                                    <CardContent className="pt-6">
                                        ...
                                        <div className="text-3xl font-bold text-purple-600 mb-2">{data?.intelligence}</div>
                                ...
                                <Card className="text-center">
                                    <CardContent className="pt-6">
                                        ...
                                        <div className="text-3xl font-bold text-yellow-600 mb-2">{data?.speed}</div>
                                ...
                                <Card className="text-center">
                                    <CardContent className="pt-6">
                                        ...
                                        <div className="text-3xl font-bold text-green-600 mb-2">{data?.durability}</div>
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="w-12 text-right font-bold">{data?.strength}/10</div>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            <div className="w-24 text-sm font-medium">Inteligencia</div>
                                            <div className="flex-1">
                                                <Progress value={data?.intelligence * 10} className="h-4" />
                                            </div>
                                            <div className="w-12 text-right font-bold">{data?.intelligence}/10</div>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="w-12 text-right font-bold">{data?.speed}/10</div>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="w-12 text-right font-bold">{data?.durability}/10</div>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="text-center py-8">
                                        ...
                                        <h3 className="text-2xl font-bold text-green-700 mb-2">{data?.team}</h3>
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-4">
                                        ...
                                        <div className="flex justify-between items-center py-2 border-b">
                                            ...
                                            <span className="font-semibold">{data?.firstAppearance}</span>
                                        </div>
                                        <div className="flex justify-between items-center py-2">
                                            <span className="text-gray-600">Años Activo:</span>
                                            <span className="font-semibold">
                                                {new Date().getFullYear() - Number.parseInt(data?.firstAppearance)} años
                                            </span>
                                        </div>
                                    </CardContent>
                                </Card>
