...
import { getInicialState, scrambleWordsReducer } from './reducer/scrambleWordReducer';
...
export const ScrambleWords = () => {
  ...
  const [state, dispatch] = useReducer(scrambleWordsReducer, getInicialState());
  ...
  const handlePlayAgain = () => {
    // const newArry = shuffleArray(GAME_WORDS);
    ...
    // setWords(newArry);
    // const siguentePalabra = newArry[0];
    // setCurrentWord(siguentePalabra)
    // setScrambledWord(scrambleWord(siguentePalabra));
